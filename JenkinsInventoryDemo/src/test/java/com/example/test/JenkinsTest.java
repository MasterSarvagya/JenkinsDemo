...
class JenkinsTest {
	 ...
	 * 
	 * @BeforeAll static void setupBeforeAll() {
	 * 
	 * products = new ArrayList<>(); products.add(new Product(1, "ABC111",
	 * "PRODUCT 1", "AAAA", 1)); products.add(new Product(2, "ABC222", "PRODUCT 2",
	 * "BBBB", 2)); products.add(new Product(3, "ABC333", "PRODUCT 3", "CCCC", 3));
	 ...
	 * }
	 * 
	 * @Test void TestAllProducts() {
	 * 
	 * ResponseEntity<ProductList> productResponseEntity =
	 * restTemplate.getForEntity("http://localhost:8080/products",
	 * ProductList.class); ProductList productList =
	 * productResponseEntity.getBody();
	 * 
	 * assertEquals(new ProductList(products), productList); }
	 * 
	 * @Test void TestProductsByCode1() {
	 * 
	 ...
	 * 
	 * @Test void TestProductsByCode2() {
	 * 
	 * assertThrows(HttpClientErrorException.class, () ->
	 * restTemplate.getForEntity("http://localhost:8080/products/code/AAAA",
	 * Product.class)); }
	 */
}
